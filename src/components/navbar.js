...
export default function Navbar({setAddWidget}) {
    ...
    return (
        <div className='bg-white h-16 border-b pl-16 fixed w-screen'>
            <div className='w-full h-full flex justify-end md:justify-between items-center p-4'>
                ...
                <div className='flex gap-2'>
                    <button className='bg-violet-50 text-violet-500 px-3 py-0.5 rounded border border-violet-200 text-sm' onClick={openAddWidget}><span className='mr-2 text-lg'>+</span>Add Widget</button>
