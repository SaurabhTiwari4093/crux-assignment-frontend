            ...
            <div className='bg-white rounded-lg shadow w-full md:w-2/3 z-10'>
                ...
                <div className='w-full p-4 pt-0 border-b-2 md:flex justify-between items-end'>
                    <div className='flex gap-2'>
                        <img src={ModelHeader} height={50} width={50} alt={"Model Header"} className='rounded border-2 p-3' />
                        <div>
                ...
                <div className='w-full p-4 grid grid-cols-3 gap-4'>
                    <div className='col-span-3 md:col-span-2 h-[400px] rounded-lg bg-violet-50'>
                    ...
                    <div className='col-span-3 md:col-span-1 h-full flex flex-col justify-between'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='border-2 rounded-lg w-full p-2 px-3'>
                        ...
                        <div className='flex gap-4'>
                            <button className='bg-violet-100 hover:bg-violet-200 border-2 border-violet-200 px-3 py-2 rounded flex justify-center items-center w-36'>
                                <img src={Clock} height={20} width={20} alt={"Clock"}/>
                            </button>
                            <button className='w-full border-2 hover:bg-gray-100 px-3 py-2 rounded'>Cancel</button>
                            <button className='w-full bg-violet-600 border-2 border-violet-700 hover:bg-violet-700 text-white px-3 py-2 rounded'>Save</button>
                        </div>
                    </div>
                </div>
            </div>
